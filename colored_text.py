def colored_text(s, c):
    """Return colored text, valid options are:
Colored Text:
gray, red, green, yellow, blue, magenta, cyan, white, crimson
Highlighted Text:
h_red, h_green, h_brown, h_blue, h_magenta, h_cyan, h_gray, h_crimson

Input is colored_text(string, color)
e.g. colored_text("A testing string", "red")
    """
